...
class MyRemindersFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        (activity as AppCompatActivity).supportActionBar!!.title = "My Reminders"

        // Inflate the layout for this fragment
        val view = inflater.inflate(R.layout.fragment_my_reminders, container, false)

        remsList = view.fragment_rv_rems
    ...
    companion object {
         ...
         * @return A new instance of fragment MyRemindersFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            MyRemindersFragment().apply {

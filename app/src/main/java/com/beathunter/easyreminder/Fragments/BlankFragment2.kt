...
class BlankFragment2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.switch1.setOnCheckedChangeListener(CompoundButton.OnCheckedChangeListener {
                buttonView, isChecked ->
            if (isChecked) bg2.setBackgroundColor(resources.getColor(R.color.cyberpunkBackground1))
            else bg2.setBackgroundColor(resources.getColor(R.color.design_default_color_primary))
        })
